...
\begin{document}
    ...
    \vspace{0.01cm}
    \begin{onecolentry}
        \textbf{Framework Patcher} Open-Source Framework Patching Tool | Python, Batch Script, Smali \hfill \textbf{( June 20, 2024 )} \\
        \begin{highlights}
    ...
    \begin{twocolentry}{
        \begin{highlights}
            ...
            \item Microsoft Azure Cloud  Computing \hfill (  Microsoft  )
        \end{highlights}
    }{
        \begin{highlights}
    ...
    \begin{highlights}
        \item Managing 46 GitHub repositories, earning 106+ stars and 60,000+ views, with 1,500+ releases and downloads.
    ...
    \begin{onecolentry}
        \begin{highlights}
            \item \textbf{LeetCode [jefinojacob9488] \ \ :} Tackled 520+ challenges, achieved 1500 rating, ranked top 25\% worldwide.
            \item \textbf{CodeChef [jefino9488] \ \ \ \ \ \ \ \ \ \ :} Earned 2 stars, hit peak rating of 1450.
            \item \textbf{Codeforces [jefino9488]\ \ \ \ \ \ \ \ \ :} Conquered 100+ tasks, secured 1120 rating, steady competitor.
        \end{highlights}
    \end{onecolentry}
