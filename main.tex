...
\newcommand{\placelastupdatedtext}{%
    \AddToShipoutPictureFG*{%
        ...
        \LenToUnit{1cm}
            ...
            \small\color{gray}\textit{\href{https://github.com/Jefino9488/Resume/releases}{Last updated in June 2025}}%
        }}}%
    }%
}
...
\begin{document}
    ...
    \begin{twocolentry}{
        \begin{highlights}
            \item \textbf{Cloud \& DevOps:} GCP, AWS [EC2, S3], Firebase, Docker
            \item \textbf{Tools:} GitHub, GitHub Actions, Selenium, APIs, JWT
