...
\newcommand{\placelastupdatedtext}{%
    \AddToShipoutPictureFG*{%
        ...
        \LenToUnit{1cm}
            ...
            \small\color{gray}\textit{\href{https://github.com/Jefino9488/Resume/releases}{Last updated in August 2025}}%
        }}}%
    }%
}
...
\begin{document}
    ...
    \vspace{0.1cm}
    \begin{onecolentry}
        \textbf{\href{https://github.com/Jefino9488/AI_Chatbot}{AI Chatbot}} Context-Aware Conversational Bot | React, Flask, Gemini, Monster API \hfill \textbf{( June 2024 )} \\
        \begin{highlights}
            \item Built a chatbot supporting text/voice input, image generation, and PDF context loading for intelligent Q\&A. \\
            \item Powered by Google Gemini models and Monster API, with voice-to-text integration for richer user experience. \\
            \item Built using a modern stack: React (Vite) frontend, Flask backend, plus PostgreSQL for storage/context management. \\
            \item Engineered for extensibility, enabling seamless integration of new actions, models, and workflows. \\
        \end{highlights}
    \end{onecolentry}
